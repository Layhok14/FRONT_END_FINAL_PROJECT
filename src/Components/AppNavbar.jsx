  ...
  return (
    <header className="sticky top-0 z-40 border-b border-line bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:flex-nowrap lg:px-8">
        <div className="w-auto shrink-0 lg:w-33">
          <BrandMark compact />
        </div>
        ...
        <div className="flex w-auto shrink-0 items-center justify-end gap-2 lg:w-33]">
          ...
          <button type="button" className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border border-line text-text-soft hover:border-primary hover:text-primary" onClick={onOpenProfile}>
