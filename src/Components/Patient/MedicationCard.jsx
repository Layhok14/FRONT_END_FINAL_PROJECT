...
export default function MedicationCard({ medication, status, amount, remark, onOpen }) {
  return (
    <button
      type="button"
      onClick={onOpen}
      className="flex min-h-[230px] flex-col rounded-[22px] border border-line bg-white p-3 text-left transition hover:border-primary hover:shadow-sm"
    >
      ...
      <div className="mt-1 min-h-[40px] text-sm text-text-soft">
        <span>Remark: </span>
