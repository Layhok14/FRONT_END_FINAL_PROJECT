...
export default function HomePage() {
  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1.45fr)_minmax(300px,0.95fr)]">
      <section className="rounded-[28px] border border-line bg-white p-5 shadow-(--shadow) sm:p-6">
        ...
        {selectedSection ? (
          <div className="rounded-3xl border border-line bg-surface-soft p-4 sm:p-5">
            <div className="relative">
              <div
                ref={trackingScrollRef}
                className="tracking-scroll max-h-160 space-y-5 overflow-y-auto pr-3"
              >
          ...
          <div className="rounded-3xl border border-line bg-surface-soft p-6 text-text-soft">No data for this date yet.</div>
        )}
      </section>
